...
class Command(BaseCommand):
    ...
    def delete_orphan_images(self):
        root = os.path.join(
            settings.MEDIA_ROOT or settings.BASE_DIR,
            'podcasts'
        )
        images = {}
        image_extensions = ('.jpg', '.jpeg', '.png', '.gif')
        image_optimizations = (
            'optimized', 'guetzlied', 'pillow', 'mozjpeged', 'pngquanted'
        )
                ...
                if n in image_extensions:
                    ...
                    try:
                        ...
                        try:
                            ...
                            podcast.image = self._make_relative_path(
                                new_full_path
                            )
                        ...
                        self.notice("Can't convert {} ({})".format(
                            f,
                            exception
                        ))
                    self.out("DELETED", f)
