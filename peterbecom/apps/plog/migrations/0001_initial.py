...
import peterbecom.apps.plog.utils
import peterbecom.apps.plog.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_date', models.DateTimeField(default=peterbecom.apps.plog.utils.utc_now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('file', models.FileField(upload_to=peterbecom.apps.plog.models._uploader_dir)),
                ('title', models.CharField(max_length=300, null=True, blank=True)),
                ('add_date', models.DateTimeField(default=peterbecom.apps.plog.utils.utc_now)),
                ('modify_date', models.DateTimeField(default=peterbecom.apps.plog.utils.utc_now)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', peterbecom.apps.plog.models.ArrayField(max_length=500)),
