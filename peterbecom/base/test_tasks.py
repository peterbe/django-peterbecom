...
@pytest.mark.django_db
def test_post_process_cached_html_mincss_cached(tmpfscacheroot, requestsmock, settings):
    ...
    requestsmock.post(settings.MINIMALCSS_SERVER_URL + "/minimize", json=json_callback)
    fn = os.path.join(tmpfscacheroot, "index.html")
    html = """
        <!doctype html>
        <html>
