...
# def test_include_classifications(admin_client):
#     blogitem1 = BlogItem.objects.create(
#         oid="hello-world",
#         title="Hello World",
#         pub_date=timezone.now(),
...
#         blogcomment=blogcomment1,
#         classification="ham",
#         text=blogcomment1.comment,
#     )
#     BlogCommentClassification.objects.create(
#         blogcomment=blogcomment3,
#         classification="spam",
#         text=blogcomment3.comment,
#     )
...
#     comment1, comment2 = response.json()["comments"]
#     assert comment1["classification"] is None
#     assert comment2["classification"] == {"classification": "ham"}
#     reply1, reply2 = comment1["replies"]
#     assert reply1["classification"] == {"classification": "spam"}
#     assert reply2["classification"] is None
