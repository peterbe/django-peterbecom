  ...
  render() {
    return (
      <form
        ...
        <div className="ui big icon input fluid" style={{display: 'relative'}}>
          <input
            type="search"
            name="term"
          ...
          {
            this.state.autocompleteSuggestions && this.state.showAutocompleteSuggestions ?
          ...
          suggestions.map((s, index) => {
            ...
            return (
              <li key={index} className={className}
                ...
                <p dangerouslySetInnerHTML={{__html: s.html}}></p>
              </li>
            )
          })
        }
